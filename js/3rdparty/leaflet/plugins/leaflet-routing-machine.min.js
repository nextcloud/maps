	...
	L.Routing.Autocomplete = L.Class.extend({
		...
		initialize: function(elem, callback, context, options) {
			...
			L.DomEvent.addListener(this._elem, 'blur', function(e) {
				...
				{
					if(!$(e.srcElement).attr('completed')){
		...
		_keyPressed: function(e) {
			...
			console.log(this.keyPressTimeout);
			clearTimeout(this.keyPressTimeout);
			var resultFn = this._resultFn;
			var completeFn = this._complete;
			this.keyPressTimeout = setTimeout(this._complete(this._resultFn, true),1000)
			if (e.keyCode === 13) {
				this._complete(this._resultFn, true);
				return;
			}
...
(function() {
	...
	L.Routing.Plan = L.Class.extend({
		...
		_createMarker: function(icon, i) {
			...
			if(i==0){
				this._map.panTo(this._waypoints[i].latLng);				
			}
