OC.L10N.register(
    ...
    "Warning: tracks or routes were found in imported files, they were ignored." : "Предупреждение: в импортираните файлове бяха намерени следи или маршрути, те бяха игнорирани.",
    ...
    "Media scan was not done yet. Wait a few minutes/hours and reload this page to see your photos/tracks." : "Сканирането на медиите все още не е извършено. Изчакайте няколко минути/часа и презаредете тази страница, за да видите вашите снимки/пътеки.",
    ...
    "Show track elevation" : "Покаване на надморската височина на пътеката",
    "Track {n} was not found" : "Пътеката {n} не беше намерена",
    "Failed to load tracks" : "Неуспешно зареждане на на пътеки",
    "Failed to load track content" : "Неуспешно зареждане на съдържанието на пътеки",
    "Failed to parse track {fname}" : "Неуспешен анализ на пътека {fname}",
    "File" : "Файл",
    "Link" : "Връзка",
    ...
    "download" : "изтегляне",
    "metadata link" : "връзка с метаданни",
    "tracks/routes name list" : "списък с имена на пътеки/маршрути",
    "no name" : "без име",
    "Distance" : "Разстояние",
    ...
    "Failed to change track color" : "Неуспешна промяна на цвета на пътеката",
