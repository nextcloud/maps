OC.L10N.register(
    ...
    "Track" : "Запис",
    "Photo location suggestions" : "Препоръки за местоположение за снимки",
    ...
    "Track {photoName} added to map {mapName}" : "Записът {photoName} е добавен към карта {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "Неуспешно запазване на запис {photoName} в карта {mapName}",
    ...
    "Devices are not yet available on custom Maps" : "Устройствата все още не са налични в персонализираните карти",
