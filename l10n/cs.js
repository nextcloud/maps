OC.L10N.register(
    ...
    "Track {photoName} added to map {mapName}" : "Stopa {photoName} přidána do mapy {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "Nepodařilo se uložit trasu {photoName} do mapy {mapName}",
