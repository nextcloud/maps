OC.L10N.register(
    ...
    "Import as devices in Maps" : "Importovat jako zařízení v mapách",
    ...
    "Turn {modifier} at the end of the road" : "Na konci cesty se otočte {modifier}",
    "onto {road}" : "na {road}",
    "Start" : "Začít",
    ...
    "By car (OSRM)" : "Auto (OSRM)",
    "By bike (OSRM)" : "Kolo (OSRM)",
    ...
    "By car (GrahHopper)" : "Autem (GrahHopper)",
    "By bike (GrahHopper)" : "Na kole (GrahHopper)",
    "By Foot (GrahHopper)" : "Pěšky (GrahHopper)",
