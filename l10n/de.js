OC.L10N.register(
    ...
    "Track {photoName} added to map {mapName}" : "Track {photoName} wurde zur Karte {mapName} hinzugefügt.",
    "Failed to save track {photoName} to map {mapName}" : "Track {photoName} zur Karte {mapName} konnte nicht gespeichert werden.",
    ...
    "Track {trackName} added to map {mapName}" : "Track {trackName} wurde zur Karte {mapName} hinzugefügt.",
