OC.L10N.register(
    ...
    "Track" : "Track",
    "Photo location suggestions" : "Photo location suggestions",
    ...
    "Track {photoName} added to map {mapName}" : "Track {photoName} added to map {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "Failed to save track {photoName} to map {mapName}",
    ...
    "Failed to save Favorite {favoriteName} to map {mapName}" : "Failed to save Favourite {favoriteName} to map {mapName}",
    "Favorite category {favoriteName} linked to map {mapName}" : "Favourite category {favoriteName} linked to map {mapName}",
    "Failed to link Favorite category {favoriteName} to map {mapName}" : "Failed to link Favourite category {favoriteName} to map {mapName}",
    "Favorite category {favoriteName} copied to map {mapName}" : "Favourite category {favoriteName} copied to map {mapName}",
    "Failed to copy Favorite category {favoriteName} to map {mapName}" : "Failed to copy Favourite category {favoriteName} to map {mapName}",
    "Favorite category {favoriteName} unlinked from map" : "Favourite category {favoriteName} unlinked from map",
    "Failed to remove Favorite category {favoriteName} from map" : "Failed to remove Favourite category {favoriteName} from map",
