OC.L10N.register(
    ...
    {
    "Maps" : "Mapas",
    "NYI" : "No disponible todavía",
    "Click on the map to move the contact, press ESC to cancel" : "Toca en el mapa para mover el contacto, pulsa ESC para cancelar",
    "Reset GEO information" : "Restablecer información GEO",
    "Move contact" : "Mover contacto",
    "Failed to reset contact location" : "Fallo al resetear la localización del contacto",
    ...
    "Toggle device history" : "Activar/desactivar historial de dispositivos",
    "Change device color" : "Cambiar color del dispositivo",
    ...
    "Battery" : "Batería",
    "Personal" : "Personal",
    "Import favorites from gpx (OsmAnd), kmz (F-Droid Maps & Maps.me) or kml file" : "Importar favoritos desde archivo gpx (Osmand), kmz (Maps [F-Droid] y Maps.me) o kml",
    ...
    "Place photo folder" : "Localizar carpeta de fotos",
    ...
    "Load gpx files from directory" : "Cargar archivos gpx desde un directorio",
    "Close elevation chart" : "Cerrar tabla de elevación",
    "Failed to remove track" : "Fallo al eliminar pista",
    "Failed to add track directory" : "Fallo al añadir directorio de pistas",
    "Failed to add tracks" : "Fallo al añadir pistas",
    "Change track color" : "Cambiar color de la pista",
    ...
    "Search…" : "Buscar...",
    "Favorites" : "Favoritos",
    "Export all favorites" : "Exportar todos los favoritos",
    "Export displayed favorites" : "Exportar los favoritos mostrados",
    "Import favorites from gpx/kml/kmz files" : "Importar favoritos de archivo gpx/kml/kmz",
    "Show all categories" : "Mostrar todas las categorías",
    "Hide all categories" : "Ocultar todas las categorías",
    "Routing" : "Ruta",
    "Export current route to gpx" : "Exportar ruta actual a gpx",
    "Photos" : "Fotos",
    "Nothing yet" : "No hay nada todavía",
    "without geo tag" : "sin etiqueta geo",
    "Save all visibile" : "Guardar todo lo visible",
    "Contacts" : "Contactos",
    "Tracks" : "Pistas",
    "Load a track file" : "Cargar un archivo de pista",
    "Show all tracks" : "Mostrar todas las pistas",
    "Hide all tracks" : "Ocultar todas las pistas",
    "Load a directory" : "Cargar un directorio",
    "Remove all tracks" : "Eliminar todas las pistas",
    "Devices" : "Dispositivos",
    "Refresh devices positions" : "Recargar posiciones de los dispositivos",
    "Show all devices" : "Mostrar todos los dispositivos",
    "Hide all devices" : "Ocultar todos los dispositivos",
    "Delete all devices history" : "Eliminar el historial de todos los dispositivos",
