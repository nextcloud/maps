OC.L10N.register(
    ...
    "Share folder not found" : "Carpeta compartida no encontrada",
    ...
    "Register Maps to open geo links" : "Registra Maps para abrir enlaces geográficos",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Autorización básica, si es necesario. El formato es \"usuario:contraseña\".",
    "support PMTiles protocol" : "compatible con el protocolo PMTiles",
    "My location" : "Mi localización",
    "Your browser does not support registering Maps to open geo links" : "Tu navegador no admite el registro de Mapas para abrir enlaces geográficos.",
    "Registration requested. Confirm it in your browser." : "Se solicita el registro. Confírmalo en tu navegador.",
    "Failed to register Maps to open geo links" : "No se ha podido registrar Mapas para abrir los enlaces geográficos",
    ...
    "Failed to upload track {name}" : "Fallo al subir la ruta {name}",
    ...
    "Photo folder" : "Carpeta de fotos",
    "Photo files" : "Archivos de fotos",
    "Choose directory of photos to place" : "Elije la carpeta de imágenes donde colocar",
    "Select {photo}" : "Selecciona {photo}",
    "Select folder" : "Selecciona carpeta",
    "_Select %n folder_::_Select %n folders_" : ["Selecciona %n carpeta","Selecciona %n carpetas","Selecciona %n carpetas"],
    "Choose photos to place" : "Elegir foto para colocar",
    "Select photo" : "Seleccionar foto",
    "_Select %n photo_::_Select %n photos_" : ["Selecciona %n foto","Seleccionar %n fotos","Seleccionar %n fotos"],
