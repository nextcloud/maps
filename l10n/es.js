OC.L10N.register(
    ...
    "Track {photoName} added to map {mapName}" : "La pista {photoName} fue añadida al mapa {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "Fallo al guardar pista {photoName} al mapa {mapName}",
    ...
    "Track {trackName} added to map {mapName}" : "La pista {trackName} fue añadida al mapa {mapName}",
    "Failed to save track {trackName} to map {mapName}" : "Fallo al guardar pista {trackName} al mapa {mapName}",
