OC.L10N.register(
    ...
    "Map not Found" : "Mapa ez da aurkitu",
    ...
    "Share was already on map" : "Partekatze hori dagoeneko bazegoen mapan",
    ...
    "Link {url} could not be copied to clipboard." : "{url} esteka ezin izan da arbelera kopiatu. ",
    ...
    "Say hi" : "Esan kaixo",
    "Hide suggestions" : "Ezkutatu iradokizunak",
    "Suggest photo locations" : "Iradokitu argazki kokalekuak",
    ...
    "Open geo links" : "Ireki geo estekak",
    ...
    "Location sources:" : "Kokapen iturriak:",
    "Tracks" : "Ibilbideak",
    "Devices" : "Gailuak",
    "Show localized photos" : "Erakutsi kokaturiko argazkiak",
    "Hide localized photos" : "Ezkutatu kokaturiko argazkiak",
    "Tags" : "Etiketak",
    ...
    "Track {date}" : "Ibilbidea {data}",
    "Route exported to {path}." : "Ibilbidea {path}-ra esportatu da.",
    "Track exported to {path}." : "Ibilbidea hona esportatu da: {path}",
    ...
    "Photo {photoName} added to map {mapName}" : "{photoName} argazkia gehitu da {mapName} mapara",
    "Failed to save photo {photoName} to map {mapName}" : "Ezin izan da {photoName} argazkia gehitu {mapName} mapara",
    "A background job added {current} from {total} new photos. This might take a while." : "Atzeko planoko lan batek {current} argazki gehitu ditu {total}(e)tik. Honek denbora behar lezake.",
    "A background job updated {current} from {total} changed photos. This might take a while." : "Atzeko planoko lan batek {current} argazki eguneratu ditu {total}(e)tik. Honek denbora behar lezake.",
    ...
    "Cleared photo cache" : "Argazkien cachea garbituta",
    "Failed to clear photos cache" : "Argazkiak garbitzeak huts egin du",
    "Saved {r} from {i} locations" : "{i} kokapenetatik {r} gorde dira",
    "Failed to save locations" : "Kokalekuak gordetzeak huts egin du",
    "Contact {contactName} added to map {mapName}" : "{contactName} kontaktua gehitu da {mapName} mapara",
    "Failed to save Contact {contactName} to map {mapName}" : "Ezin izan da {contactName} kontaktua gehitu {mapName} mapara",
    "All Contacts added to map {mapName}" : "Kontaktu guztiak gehitu dira {mapName} mapara",
    "Failed to save all Contacts to map {mapName}" : "Ezin izan dira kontaktu guztiak gehitu {mapName} mapara",
    "Failed to load contacts" : "Ezin izan dira kontaktuak kargatu",
    "Not grouped" : "Taldekatu gabe",
    "Favorite {name} was saved" : "{name} gogokoa ondo gorde da",
    "Favorite was deleted" : "Gogokoa ezabatu egin da",
    ...
    "Favorite {favoriteName} added to map {mapName}" : "{favoriteName} gogokoa gehitu da {mapName} mapara",
    "Failed to save Favorite {favoriteName} to map {mapName}" : "Ezin izan da {favoriteName} gogokoa gehitu {mapName} mapara",
    "Favorite category {favoriteName} linked to map {mapName}" : "{favoriteName} gogoko-kategoria estekatu zaio {mapName} mapari",
    "Failed to link Favorite category {favoriteName} to map {mapName}" : "Ezin izan zaio {favoriteName} gogoko-kategoria estekatu {mapName} mapari",
    "Favorite category {favoriteName} copied to map {mapName}" : "{favoriteName} gogoko-kategoria kopiatu da {mapName} mapara",
    "Failed to copy Favorite category {favoriteName} to map {mapName}" : "Ezin izan da {favoriteName} gogoko-kategoria kopiatu {mapName} mapara",
    "Favorite category {favoriteName} unlinked from map" : "{favoriteName} gogoko-kategoriaren esteka kendu da mapatik",
    "Failed to remove Favorite category {favoriteName} from map" : "Ezin izan da  {favoriteName} gogoko-kategoria kendu mapatik",
    ...
    "Track {trackName} added to map {mapName}" : " {trackName} ibilbidea gehitu da {mapName} mapara",
    "Failed to save track {trackName} to map {mapName}" : "Ezin izan da  {trackName} ibilbidea gehitu {mapName} mapara",
    ...
    "_Saved location_::_Saved all %n locations_" : ["Kokapena ondo gorde da","Ondo gorde dira %n kokapenak"],
    ...
    "Failed to import favorites" : "Gogokoak inportatzeak huts egin du",
    ...
    "Copy link to map" : "Kopiatu maparen esteka",
    ...
    "Share map not implemented yet, just go to files and share the folder." : "Mapa partekatzea ez dago inplementatuta oraindik, fitxategietara joan eta karpeta parteka dezakezu.",
    ...
    "Report Error" : "Eman errorearen abisua",
    "Failed to get favorites" : "Gogokoak eskuratzeak huts egin du",
    "Failed to create favorite" : "Gogokoa sortzeak huts egin du",
    "Failed to update favorite" : "Gogokoa eguneratzeak huts egin du",
    "Failed to delete favorite" : "Gogokoa ezabatzeak huts egin du",
    "Metadata" : "Metadatuak",
    "Restaurant" : "Jatetxea",
    "Fast food" : "Fast food",
    "Bar" : "Taberna",
