OC.L10N.register(
    ...
    "Share folder not found" : "Dossier du partage introuvable",
    ...
    "Register Maps to open geo links" : "Inscrire Cartes pour ouvrir les liens géo",
    "Display time filter slider" : "Afficher le curseur de filtre temporel",
    "The True Size of Africa" : "La Vraie taille de l'Afrique",
    "Cancel adding favorites" : "Annuler l'ajout aux favoris",
    "(No name)" : "(Sans nom)",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Identification Basic si nécessaire. Le format est &quot;utilisateur:motdepasse&quot;",
    "support PMTiles protocol" : "support du protocole PMTiles",
    ...
    "Failed to upload track {name}" : "Échec du téléversement de la trace {name}",
    ...
    "_One device imported_::_%n devices imported_" : ["Un appareil importé","%n appareils importés","%n appareils importés"],
    "Import as favorites in Maps" : "Importer comme favoris sur la carte",
    "_One favorite imported_::_%n favorites imported_" : ["Un favori importé","%n favoris importés","%n favoris importés"],
    ...
    "What do you want to place" : "Ce que vous voulez placer",
    "Photo folder" : "Dossier de photos",
    "Photo files" : "Fichiers image",
    "Choose directory of photos to place" : "Choisissez le répertoire des phots à insérer",
    "Select {photo}" : "Sélectionner {photo}",
    "Select folder" : "Sélectionner un dossier",
    "_Select %n folder_::_Select %n folders_" : ["Sélectionner %n dossier","Sélectionner %n dossiers","Sélectionner %n dossiers"],
    "Choose photos to place" : "Choisir des photos à insérer",
    "Select photo" : "Sélectionner des photos",
    "_Select %n photo_::_Select %n photos_" : ["Sélectionner %n photo","Sélectionner %n photos","Sélectionner %n photos"],
