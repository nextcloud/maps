OC.L10N.register(
    ...
    "Register Maps to open geo links" : "Cláraigh Léarscáileanna chun naisc gheo a oscailt",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Údarú Bunúsach más gá. Is é &quot;úsáideoir:pasfhocal&quot; an fhormáid.",
    "support PMTiles protocol" : "tacaíocht a thabhairt do phrótacal PMTiles",
    "My location" : "Mo shuíomh",
    "Your browser does not support registering Maps to open geo links" : "Ní thacaíonn do bhrabhsálaí le Léarscáileanna a chlárú chun naisc gheografacha a oscailt",
    "Registration requested. Confirm it in your browser." : "Iarradh clárú. Deimhnigh é i do bhrabhsálaí.",
    "Failed to register Maps to open geo links" : "Theip ar Léarscáileanna a chlárú chun naisc gheo a oscailt",
    ...
    "Failed to upload track {name}" : "Theip ar an rian {name} a uaslódáil",
    ...
    "Photo folder" : "Fillteán grianghraf",
    "Photo files" : "Comhaid grianghraf",
    "Choose directory of photos to place" : "Roghnaigh eolaire grianghraf le cur",
    "Select {photo}" : "Roghnaigh {photo}",
    "Select folder" : "Roghnaigh fillteán",
    "_Select %n folder_::_Select %n folders_" : ["Roghnaigh %n fillteán","Roghnaigh %n fillteáin","Roghnaigh %n fillteáin","Roghnaigh %n fillteáin","Roghnaigh %n fillteáin"],
    "Choose photos to place" : "Roghnaigh grianghraif le cur",
    "Select photo" : "Roghnaigh grianghraf",
    "_Select %n photo_::_Select %n photos_" : ["Roghnaigh %n grianghraf","Roghnaigh %n grianghraif","Roghnaigh %n grianghraif","Roghnaigh %n grianghraif","Roghnaigh %n grianghraif"],
    "Restaurant" : "Bialann",
