OC.L10N.register(
    ...
    "Device {deviceName} linked to map {mapName}" : "{deviceName} eszköz hozzákötve {mapName} térképhez",
    "Failed to link Device to map {mapName}" : "A következő térképhez nem sikerült az eszközt hozzákötni: {mapName}",
