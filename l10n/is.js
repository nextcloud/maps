OC.L10N.register(
    ...
    {
    "Maps" : "Landakort",
    "Click on the map to move the contact, press ESC to cancel" : "Smelltu á kortið til að færa tengiliðinn, ýttu á ESC til að hætta við",
    "Reset GEO information" : "Endurstilla hnattstöðuupplýsingar",
    "Move contact" : "Færa tengilið",
    "Failed to reset contact location" : "Tókst ekki að endurstilla staðsetningu tengiliðar",
    ...
    "Place photo folder" : "Staðsetja möppu með ljósmyndum",
    ...
    "Load gpx files from directory" : "Hlaða inn GPX-skrám úr möppu",
    "Close elevation chart" : "Loka hæðalínuriti",
    "Failed to remove track" : "Mistókst að fjarlægja feril",
    "Failed to add track directory" : "Mistókst að bæta við ferlamöppu",
    "Failed to add tracks" : "Mistókst að bæta við ferlum",
    "Change track color" : "Breyta lit á ferli",
    ...
    "download" : "sækja",
    "metadata link" : "tengill á lýsigögn",
    "tracks/routes name list" : "nafnalisti ferla/leiða",
    "no name" : "ekkert heiti",
    "Distance" : "Vegalengd",
    "Duration" : "Tímalengd",
    ...
    "Hide all" : "Fela allt",
    "Routing" : "Leiðaval",
    "Export current route to gpx" : "Flytja út núverandi leið í GPX",
    "Photos" : "Ljósmyndir",
    "Nothing yet" : "Ekkert ennþá",
    "without geo tag" : "án hnattstöðumerkingar",
    "Save all visibile" : "Vista allt sýnilegt",
    "Contacts" : "Tengiliðir",
    "Tracks" : "Ferlar",
    "Load a track file" : "Hlaða inn ferilskrá",
    "Load a directory" : "Hlaða inn möppu",
