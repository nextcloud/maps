OC.L10N.register(
    ...
    "Maps" : "地図",
    "NYI" : "まだ実装されていません",
    "Click on the map to move the contact, press ESC to cancel" : "マップをクリックして連絡先を移動, ESCでキャンセルします",
    ...
    "Failed to get contact list" : "連絡先リストの取得ができませんでした。",
    ...
    "Failed to update device points" : "端末の場所の更新ができませんでした",
    "Impossible to get current location" : "現在地を取得できません",
    "Failed to send current position" : "現在地の送信ができませんでした",
    ...
    "Failed to load favorites" : "お気に入りの読み込みができませんでした",
    "Add a favorite" : "お気に入りを追加",
    "Rename" : "名前を変更",
    "Category deleted" : "カテゴリ削除",
    "Failed to rename category" : "カテゴリ名の変更ができませんでした",
    "Failed to delete category favorites" : "お気に入りカテゴリの削除に失敗しました",
    "Failed to add favorite" : "お気に入りの追加ができませんでした",
    "Name" : "名前",
    "No name" : "名前なし",
    "Category" : "カテゴリ",
    "Comment" : "コメント",
    ...
    "Move" : "移動",
    "Failed to delete favorite" : "お気に入りの削除ができませんでした。",
    ...
    "Failed to load photos" : "写真の読み込みができませんでした",
    ...
    "Failed to save option values" : "オプション値の保存ができませんでした",
    "Failed to restore options values" : "オプション値の復元ができませんでした",
    "Place photos" : "写真を配置",
    ...
    "Failed to add track directory" : "ディレクトリから追跡の追加ができませんでした",
    "Failed to add tracks" : "追跡の追加ができませんでした",
