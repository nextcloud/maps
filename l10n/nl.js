OC.L10N.register(
    ...
    "No such device" : "Geen dergelijk apparaat",
    "Map not Found" : "Kaart niet gevonden",
    "No device to export" : "Geen apparaat om te exporteren",
    "/Maps is not a directory" : "/Maps is geen map",
    "/Maps directory is not writeable" : "/Maps directory is niet schrijfbaar",
    "Impossible to create /Maps directory" : "Kon /Maps map niet aanmaken",
    ...
    "Error sharing device" : "Fout bij het delen van apparaat",
    "No such favorite" : "Favoriet niet gevonden",
    "invalid values" : "ongeldige waarden",
    "no such favorite" : "favoriet niet gevonden",
    "Unknown category" : "Onbekende categorie",
    "Bad file type" : "Ongeldig bestandstype",
    ...
    "Zoom" : "Zoom",
    "Copy to map" : "Kopieer naar kaart",
    "Hide history" : "Verberg geschiedenis",
    "Show history" : "Toon geschiedenis",
    "Change color" : "Wijzigen kleur",
    "Zoom on area" : "Zoom op gebied",
    "Export" : "Exporteren",
    "Link to map" : "Link naar kaart",
    "Delete" : "Verwijderen",
    ...
    "Create share link" : "Maak deellink",
    "Copied!" : "Gekopieerd!",
    ...
    "Add Map" : "Kaart toevoegen",
    "My photos" : "Mijn foto's",
    "Disable photo drag" : "Foto slepen uitschakelen",
    "Enable photo drag" : "Foto slepen inschakelen",
    "Say hi" : "Zeg hoi",
    "Hide suggestions" : "Verberg suggesties",
    "Suggest photo locations" : "Suggereer fotolocaties",
    "Clear photo cache" : "Foto cache legen",
    "Show track elevation" : "Toon hoogteprofiel",
    "Download track" : "Download track",
    "My tracks" : "Mijn tracks",
    ...
    "Comment" : "Reactie",
    "Location" : "Locatie",
    "New category {n}" : "Nieuwe categorie {n}",
    "Save" : "Opslaan",
    ...
    "Geo link could not be copied to clipboard" : "Geo link kon niet worden gekopieerd",
    "Close" : "Sluit",
    ...
    "No name" : "Geen naam",
    "Update" : "Bijwerken",
    "Move photo" : "Verplaats foto",
    "Add favorite" : "Favoriet toevoegen",
    "Edit favorite" : "Favoriet bewerken",
    "Rename favorite category" : "Favorieten categorie hernoemen",
    "Delete contact address" : "Verwijder contactadres",
    "Undo {action} (Ctrl+Z)" : "Ongedaan maken {action} (Ctrl+Z)",
    "Redo {action} (Ctrl+Shift+Z)" : "Opnieuw uitvoeren {action} (Ctrl+Shift+Z)",
    "Select All" : "Alles Selecteren",
    "Display pictures" : "Foto's weergeven",
    "Spiderfy" : "Spiderfy",
    "Are you sure you want to remove geo data of {nb} photos?" : "Bent u zeker dat u de geogegevens van {nb} foto's wilt verwijderen?",
    "Yes" : "Ja",
    "Open in Sidebar" : "Open zijbalk",
    "Remove geo data" : "Verwijder geo data",
    "New contact address" : "Nieuw adres voor een contact",
    "Choose a contact" : "Kies een contactpersoon",
    ...
    "Photo {photoName} added to map {mapName}" : "Foto {photoName} toegevoegd aan kaart {mapName}",
    "Failed to save photo {photoName} to map {mapName}" : "Mislukt om foto {photoName} op te slaan in kaart {mapName}",
    "_Saved location_::_Saved all %n locations_" : ["Locatie opgeslagen","Alle %n de locaties opgeslagen"],
    ...
    "Favorite {favoriteName} added to map {mapName}" : "Favoriet {favoriteName} toegevoegd aan kaart {mapName}",
    "Failed to save Favorite {favoriteName} to map {mapName}" : "Kon favoriet {favoriteName} niet toevoegen aan kaart {mapName}",
    ...
    "Failed to import devices" : "Kon apparaten niet importeren",
    "Default" : "Standaard",
    ...
    "GraphHopper API key (mandatory if main server used)" : "GraphHopper API-sleutel (verplicht als de hoofdserver wordt gebruikt)",
    ...
    "Mapbox API key" : "Mapbox API-sleutel"
},
