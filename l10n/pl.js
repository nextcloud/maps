OC.L10N.register(
    ...
    "Turn {modifier} on the ramp" : "Włącz {modifier} przy pochyleniu",
    "Take the ramp on the {modifier}" : "Ustaw pochylenie na {modifier}",
    "Turn {modifier} at the end of the road" : "Włącz {modifier} na końcu drogi",
    "onto {road}" : "na {road}",
    "Start" : "Start",
    ...
    "Simple maps app to display a leaflet map." : "Prosta aplikacja do wyświetlania map.",
    ...
    "OSRM server URL (car profile)" : "Adres URL serwera OSRM (profil samochodu)",
    "OSRM server URL (bicycle profile)" : "Adres URL serwera OSRM (profil rowerowy)",
    "OSRM server URL (foot profile)" : "Adres URL serwera OSRM (profil stopy)",
