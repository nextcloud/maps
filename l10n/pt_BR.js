OC.L10N.register(
    ...
    "Map mot Found" : "Mapa não Encontrado",
    "share was allready on map" : "o compartilhamento já estava no mapa",
    ...
    "Devices are not yet available on custom Maps" : "Os dispositivos ainda não estão disponíveis em mapas personalizados",
    ...
    "_saved location_::_saved all %n locations_" : ["localização salva","salvou todas as %n localizações","salvou todas as %n localizações"],
    ...
    "Share map not implemented yet, just goto files and share the folder." : "Mapa de compartilhamento ainda não implementado, basta acessar os arquivos e compartilhar a pasta.",
