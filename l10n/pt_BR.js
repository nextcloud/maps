OC.L10N.register(
    ...
    "Register Maps to open geo links" : "Registrar Mapas para abrir links geográficos",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Autorização Básica é obrigatória. O formato é &quot;usuário:senha&quot;",
    "support PMTiles protocol" : "suportar o protocolo PMTiles",
    "My location" : "Minha localização",
    "Your browser does not support registering Maps to open geo links" : "Seu navegador não suporta o registro do Mapas para abrir links geográficos",
    "Registration requested. Confirm it in your browser." : "Registração solicitada. Confirme no seu navegador.",
    "Failed to register Maps to open geo links" : "Falha ao registrar o Mapas para abrir links geográficos",
    ...
    "Failed to upload track {name}" : "Falha ao carregar trilha {name}",
    ...
    "_One device imported_::_%n devices imported_" : ["Um dispositivo importado","%n de dispositivos importados","%n dispositivos importados"],
    "Import as favorites in Maps" : "Importar como favoritos no Maps",
    "_One favorite imported_::_%n favorites imported_" : ["Um favorito importado","%n de favoritos importados","%n favoritos importados"],
