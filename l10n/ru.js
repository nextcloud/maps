OC.L10N.register(
    ...
    "Zoom" : "Мастштаб",
    "Toggle history" : "Показать или скрыть историю",
    ...
    "Shows cool information" : "Показывать дополнительные сведения",
    "Distance" : "Расстояние",
    ...
    "Failed to get contact list" : "Не удалось получить список контактов",
    "Failed to place contact" : "Не удалось разместить контакт",
    "Failed to load device list" : "Не удалось получить список устройств",
    "Device deleted" : "Устройство удалено",
    "Failed to rename device" : "Не удалось переименовать устройство",
    "Failed to load device points" : "Не удалось загрузить список точек устройства",
    "Failed to update device points" : "Не удалось обновить список точек устройства",
    "Failed to change device color" : "Не удалось изменить цвет устройства",
    "Elevation" : "Высота",
    "Failed to remove favorites category share" : "Не удалось закрыть доступ к категории «Избранное»",
    "Failed to share favorites category" : "Не удалось опубликовать категорию «Избранное»",
    "Failed to load favorites" : "Не удалось загрузить избранное",
    "Failed to load favorite share token" : "Не удалось получить токен совместного доступа к избранному",
    ...
    "Click on the map to move the favorite, press Esc to cancel" : "Нажмите на карту, чтобы переместить избранное, либо нажмите Esc для отмены",
    ...
    "Zoom in" : "Приблизить",
    "Click on the map to move the photo, press Esc to cancel" : "Нажмите на карту для перемещения фотографии, либо нажмите Esc для отмены.",
    ...
    "Tracks/routes name list" : "Список названий путей/маршрутов",
    "no date" : "без даты",
