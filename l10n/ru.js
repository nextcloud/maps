OC.L10N.register(
    ...
    "_One device imported_::_%n devices imported_" : ["Одно устройство импортировано","%n устройства импортировано","%n устройств импортировано","%n устройств импортировано"],
    "Import as favorites in Maps" : "Импортировать в избранное в приложение Карты",
    "_One favorite imported_::_%n favorites imported_" : ["Одно избранное импортировано","%n избранных импортировано","%n избранных импортировано","%n избранных импортировано"],
    ...
    "Metadata" : "Метаданные",
    "What do you want to place" : "Что вы хотите разместить",
    "Photo folder" : "Папка фотографий",
    "Photo files" : "Файлам фотографий",
    "Choose directory of photos to place" : "Выберите каталог фотографий для размещения",
    "Select {photo}" : "Выбрать {photo}",
    "Select folder" : "Выделить папку",
    "_Select %n folder_::_Select %n folders_" : ["Выберите %n папку","Выберите %n папки","Выберите %n папок","Выберите %n папок"],
    "Choose photos to place" : "Выберите фотографии для размещения",
    "Select photo" : "Выбрать фото",
    "_Select %n photo_::_Select %n photos_" : ["Выбрать %n фотографию","Выбрать %n фотографии","Выбрать %n фотографий","Выбрать %n фотографий"],
    "Restaurant" : "Ресторан",
    "Fast food" : "Фаст-фуд",
    "Bar" : "Бар",
    ...
    "support PMTiles protocol" : "поддержка протокола PMTiles",
