OC.L10N.register(
    ...
    "Share folder not found" : "Priečinok zdieľania sa nenašiel",
    ...
    "Register Maps to open geo links" : "Zaregistrovať Mapy na otváranie geografických odkazov",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Základná autorizácia, ak sa vyžaduje. Formát je &quot;user:password&quot;",
    "support PMTiles protocol" : "podpora protokolu PMTiles",
    "My location" : "Moja poloha",
    "Your browser does not support registering Maps to open geo links" : "Váš prehliadač nepodporuje registráciu Máp na otváranie geografických odkazov",
    "Registration requested. Confirm it in your browser." : "Registrácia vyžiadaná. Potvrďte ju vo svojom prehliadači.",
    "Failed to register Maps to open geo links" : "Registrácia Máp na otváranie geografických odkazov zlyhala",
    ...
    "Failed to upload track {name}" : "Nepodarilo sa nahrať trasu {name}",
    ...
    "_One device imported_::_%n devices imported_" : ["Importované jedno zariadenie","Importované %n zariadenia","Importovaných %n zariadení","Importovaných %n zariadení"],
    "Import as favorites in Maps" : "Importovať v Mapách ako obľúbené",
    "_One favorite imported_::_%n favorites imported_" : ["Importovaná jedna obľúbená položka","Importované %n obľúbené položky","Importovaných %n obľúbených položiek","Importovaných %n obľúbených položiek"],
    ...
    "Photo folder" : "Priečinok s fotografiami",
    "Photo files" : "Foto súbory",
    "Choose directory of photos to place" : "Vyberte priečinok s fotografiami, ktoré chcete umiestniť",
    "Select {photo}" : "Vybrať {photo}",
    "Select folder" : "Vybrať priečinok",
    "_Select %n folder_::_Select %n folders_" : ["Vybrať %n priečinok","Vybrať %n priečinky","Vybrať %n priečinkov","Vybrať %n priečinkov"],
    "Choose photos to place" : "Vyberte fotografie, ktoré chcete umiestniť",
    "Select photo" : "Vybrať fotografiu",
    "_Select %n photo_::_Select %n photos_" : ["Vybrať %n fotografiu","Vybrať %n fotografie","Vybrať %n fotografií","Vybrať %n fotografií"],
