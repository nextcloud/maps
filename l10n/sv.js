OC.L10N.register(
    ...
    "Home" : "Hem",
    "Work" : "Arbete",
    "Delete this address" : "Ta bort denna adress",
    ...
    "Turn {modifier} on the ramp" : "Svänng {modifier} på avfarten",
    "Take the ramp on the {modifier}" : "Ta avfart på {modifier}",
    ...
    "Route exported in {path}" : "Rutt exporterad i {path}",
    "Failed to export current route" : "Misslyckades att exportera aktuell rutt",
    "There is no route to export" : "Det finns ingen rutt att exportera",
    ...
    "Failed to load track content" : "Kunde inte ladda spårinnehåll",
    "Link" : "Länk",
    "Latitude" : "Latitud",
    "Longitude" : "Longitud",
    ...
    "Graphhopper Website" : "Graphhopper hemsida",
