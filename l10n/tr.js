OC.L10N.register(
    ...
    "No such favorite" : "Böyle bir sık kullanılan yok",
    "invalid values" : "Değerler geçersiz",
    "no such favorite" : "Böyle bir sık kullanılan yok",
    "Unknown category" : "Kategori bilinmiyor",
    "Error sharing favorite" : "Sık kullanılan paylaşılırken sorun çıktı",
    ...
    "My favorites" : "Sık kullanılanlarım",
    "Disable favorite drag" : "Sık kullanılan sürüklemeyi devre dışı bırak",
    "Enable favorite drag" : "Sık kullanılan sürüklemeyi etkinleştir",
    "Import" : "İçe aktar",
    ...
    "Accuracy" : "Doğruluk",
    "No name" : "Adsız",
    "Delete favorite" : "Sık kullanılanı sil",
    "Update" : "Güncelle",
    ...
    "Favorite {favoriteName} added to map {mapName}" : "{favoriteName} sık kullanılan ögesi {mapName} haritasına eklendi",
    "Failed to save Favorite {favoriteName} to map {mapName}" : "{favoriteName} sık kullanılan ögesi {mapName} haritasına eklenemedi",
    "Favorite category {favoriteName} linked to map {mapName}" : "{favoriteName} sık kullanılan kategorisi {mapName} haritası ile ilişkilendirildi",
    "Failed to link Favorite category {favoriteName} to map {mapName}" : "{favoriteName} sık kullanılan kategorisi {mapName} haritası ile ilişkilendirilemedi",
    "Favorite category {favoriteName} copied to map {mapName}" : "{favoriteName} sık kullanılan kategorisi {mapName} haritasına kopyalandı",
    "Failed to copy Favorite category {favoriteName} to map {mapName}" : "{favoriteName} sık kullanılan kategorisi {mapName} haritasına kopyalanamadı",
    "Favorite category {favoriteName} unlinked from map" : "{favoriteName} sık kullanılan kategorisinin {mapName} haritası ile ilişkisi kaldırıldı",
    "Failed to remove Favorite category {favoriteName} from map" : "{favoriteName} sık kullanılan kategorisinin {mapName} haritası ile ilişkisi kaldırılamadı",
