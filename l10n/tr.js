OC.L10N.register(
    ...
    "Map mot Found" : "Harita bulunamadı",
    "share was allready on map" : "Paylaşım zaten harita üzerinde",
    ...
    "Track {photoName} added to map {mapName}" : "{photoName} rotası {mapName} haritasına eklendi",
    "Failed to save track {photoName} to map {mapName}" : "{photoName} rotası {mapName} haritasına eklenemedi",
    ...
    "Share map not implemented yet, just goto files and share the folder." : "Harita paylaşma özelliği henüz eklenmedi. Dosyalara giderek klasörü paylaşın.",
