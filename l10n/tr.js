OC.L10N.register(
    ...
    "Maps" : "Haritalar",
    "NYI" : "NYI",
    "Click on the map to move the contact, press ESC to cancel" : "Kişiyi taşımak için harita üzerine tıklayın, iptal etmek için ESC tuşuna basın",
    "Reset GEO information" : "Coğrafi bilgileri sıfırla",
    "Move contact" : "Kişiyi taşı",
    "Failed to reset contact location" : "Kişi konumu sıfırlanamadı",
    ...
    "Toggle device history" : "Aygıt geçmişini aç/kapat",
    "Change device color" : "Aygıt rengini değiştir",
    ...
    "Battery" : "Pil",
    "Personal" : "Kişisel",
    "Import favorites from gpx (OsmAnd), kmz (F-Droid Maps & Maps.me) or kml file" : "Sık kullanılanları gpx (OsmAnd), kmz (F-Droid Haritaları ve maps.me) ya da kml dosyasından içe aktarır",
    ...
    "Place photo folder" : "Fotoğraf klasörünü yerleştir",
    ...
    "See current location" : "Geçerli konumu görüntüle",
    "Other layers" : "Diğer katmanlar",
    "Aerial map" : "Havadan görünüş",
    "Classic map" : "Klasik harita",
    "north" : "kuzey",
    "northeast" : "kuzeydoğu",
    "east" : "doğu",
    "southeast" : "güneydoğu",
    ...
    "Import favorites from gpx/kml/kmz files" : "Sık kullanılanları gpx/kml/kmz dosyalarından içe aktar",
    ...
    "without geo tag" : "coğrafi konum verisi olmadan",
