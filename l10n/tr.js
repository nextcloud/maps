OC.L10N.register(
    ...
    "Share folder not found" : "Paylaşım klasörü bulunamadı",
    ...
    "Register Maps to open geo links" : "Coğrafi bağlantılar için Haritalar uygulaması kaydedilsin",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "Gerekirse temel kimlik doğrulama. Biçim: &quot;KullanıcıAdı:Parola&quot;",
    "support PMTiles protocol" : "PMTiles iletişim kuralı desteği",
    "My location" : "Konumum",
    "Your browser does not support registering Maps to open geo links" : "Tarayıcınız coğrafi bağlantıları açmak için Haritalar uygulamasının kaydedilmesini desteklemiyor",
    "Registration requested. Confirm it in your browser." : "Kayıt isteğinde bulunuldu. Tarayıcınızda onaylayın.",
    "Failed to register Maps to open geo links" : "Coğrafi bağlantıları açmak için Haritalar uygulaması kaydedilemedi",
    ...
    "Failed to upload track {name}" : "{name} rotası yüklenemedi",
