OC.L10N.register(
    ...
    "Elevation" : "海拔",
    "Failed to remove favorites category share" : "无法删除收藏夹分类分享",
    "Failed to share favorites category" : "无法分享收藏夹分类",
    "Failed to load favorites" : "无法加载收藏",
    "Failed to load favorite share token" : "无法加载收藏夹分享令牌",
    "Share link" : "分享链接",
    "Copy link" : "复制链接",
    ...
    "Click on the map to move the favorite, press Esc to cancel" : "点击地图移动收藏，按 Esc 取消",
    ...
    "Zoom in" : "放大",
    "Click on the map to move the photo, press Esc to cancel" : "点击地图移动照片，按 Esc 取消",
    "Failed to load photos" : "无法加载照片",
    "{nb} photos placed" : "已放置 {nb} 张照片",
    "Failed to place photos" : "无法放置照片",
    "{nb} photos reset" : "已重置 {nb} 张照片",
    ...
    "Failed to export current route" : "无法导出当前路线",
    "There is no route to export" : "没有可以导出的路线",
