OC.L10N.register(
    ...
    "Tags" : "标签",
    "Shows cool information" : "显示酷的信息",
    "Sidebar" : "侧边栏",
    "Favorite" : "收藏",
    "Photo suggestions" : "照片建议",
    "Track metadata" : "轨迹元数据",
    "Track" : "曲目",
    "Photo location suggestions" : "照片位置建议",
    ...
    "Failed to export route" : "无法导出路线",
    "Failed to export track" : "无法导出轨迹",
    ...
    "Import favorites from GeoJSON (Google Maps), gpx (OsmAnd, Nextcloud Maps) or kmz/kml (F-Droid Maps, Maps.me, Marble)" : "从 GeoJSON（谷歌地图），gpx（OsmAnd，Nextcloud地图）或kmz/kml（F-Droid地图，Maps.me，Marble）文件中导入收藏",
    ...
    "Import devices from gpx (Nextcloud Maps) or kml/kmz (Google Timeline) file" : "从 gpx（Nextcloud 地图）或 kml/kmz（Google 时间线）文件导入设备",
    "{nb} devices imported from {path}" : "已从 {path} 导入 {nb} 个设备",
    "Failed to import devices" : "无法导入设备",
    "Default" : "默认",
    "_Saved location_::_Saved all %n locations_" : ["保存全部 %n 个位置"],
    ...
    "Failed to update favorite" : "无法更新收藏夹",
    ...
    "OSRM Website" : "开源路由机 OSRM 网站",
    "OSRM settings" : "OSRM 设置",
    "An OSRM server URL looks like this : https://my.osrm.server.org:5000/route/v1" : "OSRM 服务器 URL 格式如下：https://my.osrm.server.org:5000/route/v1",
    "Leave URL fields empty to disable OSRM routing provider." : "将 URL 字段留空以禁用 OSRM 路由提供者。",
    "OSRM server URL (car profile)" : "OSRM 服务器 URL（小汽车配置）",
    "OSRM server URL (bicycle profile)" : "OSRM 服务器URL（自行车配置）",
    "OSRM server URL (foot profile)" : "OSRM 服务器URL（步行配置）",
    "Show OSRM demo server" : "显示 OSRM 演示服务器",
    "Graphhopper Website" : "Graphhopper 网站",
    "GraphHopper settings" : "GraphHopper 设置",
    "A GraphHopper server URL looks like this : https://my.graphhopper.server.org:8989/route" : "GraphHopper 服务器 URL 格式如下：https://my.graphhopper.server.org:8989/route",
    ...
    "Mapbox Website" : "Mapbox 网站",
    "Mapbox settings" : "Mapbox 设置",
