OC.L10N.register(
    ...
    "Map mot Found" : "沒有找到地圖",
    "share was allready on map" : "分享已經在地圖上",
    ...
    "Track {date}" : "足跡 {date}",
    "Track {photoName} added to map {mapName}" : "記錄 {photoName} 添加到地圖 {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "無法將記錄 {photoName} 保存到地圖 {mapName}",
    ...
    "Share map not implemented yet, just goto files and share the folder." : "地圖分享尚未實現，只需轉到檔案並分享資料夾即可。",
