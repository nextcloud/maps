OC.L10N.register(
    ...
    "Share folder not found" : "找不到分享資料夾",
    ...
    "Register Maps to open geo links" : "將 Maps 註冊為開啟 geo 連結的應用程式",
    ...
    "Route {date}" : "路線 {date}",
    "Track {date}" : "足跡 {date}",
    "Route exported to {path}." : "匯出路線到 {path}。",
    "Track exported to {path}." : "匯出軌跡到 {path}。",
    "Failed to export route" : "匯出路線失敗",
    "Failed to export track" : "匯出足跡失敗",
    "Via {i}" : "經由 {i}",
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "如有需要，請使用基本驗證。格式為「user:password」",
    "support PMTiles protocol" : "支援 PMTiles 協定",
    "My location" : "我的位置",
    "Your browser does not support registering Maps to open geo links" : "您的瀏覽器不支援將 Maps 註冊為開啟 geo 連結的應用程式",
    "Registration requested. Confirm it in your browser." : "已要求註冊。請在瀏覽器中確認。",
    "Failed to register Maps to open geo links" : "將 Maps 註冊為開啟 geo 連結的應用程式失敗",
    ...
    "Favorites exported in {path}" : "匯出的我的收藏位置 {path}",
    ...
    "Failed to upload track {name}" : "無法上傳軌跡 {name}",
