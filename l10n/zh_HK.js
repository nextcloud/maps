OC.L10N.register(
    ...
    "/Maps is not writeable" : "/Maps 無法寫入",
    "Impossible to create /Maps" : "無法建立 /Maps",
    ...
    "Failed to load device list" : "加載裝置清單失敗",
    "Device deleted" : "裝置已刪除",
    "Failed to rename device" : "重新命名裝置失敗",
    "Failed to load device points" : "加載裝置位置失敗",
    "Failed to update device points" : "更新裝置位置失敗",
    "Failed to change device color" : "更改裝置顏色失敗",
    "Elevation" : "高度",
    "Failed to remove favorites category share" : "移除我的收藏分類分享失敗",
    "Failed to share favorites category" : "分享我的收藏分類失敗",
    "Failed to load favorites" : "載入我的收藏失敗",
    "Failed to load favorite share token" : "載入我的收藏分享權杖失敗",
    "Share link" : "分享連結",
    "Copy link" : "複製連結",
    "Category deleted" : "分類已刪除",
    "Failed to rename category" : "重新命名分類失敗",
    "Failed to delete category favorites" : "刪除我收藏的分類失敗",
    "Failed to add favorite" : "加入我的收藏失敗",
    "Submit" : "送出",
    "Move" : "移動",
    "Failed to delete favorite" : "刪除我的收藏失敗",
    "Failed to edit favorite" : "編輯我的收藏失敗",
    "Click on the map to move the favorite, press Esc to cancel" : "在地圖點選位置來移動最愛，按 Esc 鍵取消。",
    ...
    "Zoom in" : "放大",
    "Click on the map to move the photo, press Esc to cancel" : "在地圖點選位置來移動照片，按 Esc 鍵取消。",
    ...
    "Export current route to GPX" : "導出路線為GPX檔",
    "Route exported in {path}" : "由 {path} 導入路線",
    "Failed to export current route" : "導出路線失敗",
    "There is no route to export" : "未選定導出路線",
    ...
    "Download" : "下載",
    "Metadata link" : "元數據連結 ",
    "Tracks/routes name list" : "軌跡/路線名單",
    "no date" : "無日期",
    "Show elevation" : "顯示高程",
