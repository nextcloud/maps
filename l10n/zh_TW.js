OC.L10N.register(
    ...
    "Map mot Found" : "找不到地圖",
    "share was allready on map" : "分享已在地圖上",
    ...
    "Track {date}" : "軌跡 {date}",
    "Track {photoName} added to map {mapName}" : "軌跡 {photoName} 已新增至地圖 {mapName}",
    "Failed to save track {photoName} to map {mapName}" : "儲存軌跡 {photoName} 至地圖 {mapName} 失敗",
    ...
    "saved {r} from {i} locations" : "從 {i} 個位置儲存了 {r}",
    ...
    "Devices are not yet available on custom Maps" : "裝置在自訂地圖上尚不可用",
    ...
    "Share map not implemented yet, just goto files and share the folder." : "尚未實作分享地圖，僅需到檔案並分享資料夾即可。",
