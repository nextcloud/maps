OC.L10N.register(
    ...
    "Basic Authorization if required. Format is &quot;user:password&quot;" : "如有需要，請進行基本授權。格式為「使用者名稱:密碼」",
    ...
    "Failed to upload track {name}" : "上傳軌跡 {name} 失敗",
    ...
    "_One device imported_::_%n devices imported_" : ["已匯入 %n 個裝置"],
    "Import as favorites in Maps" : "從地圖上匯入收藏",
    "_One favorite imported_::_%n favorites imported_" : ["已匯入 %n 個最愛"],
    ...
    "Metadata" : "詮釋資料",
    "What do you want to place" : "您想放置什麼？",
    "Photo folder" : "照片資料夾",
    "Photo files" : "照片檔案",
    "Choose directory of photos to place" : "選擇要放置照片的目錄",
    "Select {photo}" : "選取 {photo}",
    "Select folder" : "選取資料夾",
    "_Select %n folder_::_Select %n folders_" : ["選取 %n 個資料夾"],
    "Choose photos to place" : "選擇要放置的照片",
    "Select photo" : "選取照片",
    "_Select %n photo_::_Select %n photos_" : ["選取 %n 張照片"],
    "Restaurant" : "餐廳",
    "Fast food" : "速食店",
    "Bar" : "酒吧",
    "Supermarket" : "超市",
