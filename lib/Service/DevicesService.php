...
class DevicesService {
    ...
    public function countDevices($userId, $deviceIdList, $begin, $end) {
    }

    public function exportDevices($this->userId, $handler, $deviceIdList, $begin, $end, $appVersion) {
    }
