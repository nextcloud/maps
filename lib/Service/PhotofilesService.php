...
class PhotofilesService {
	...
	public function updateByFile(File $file): void {
	...
	private function setGeolocation(\lsolesen\pel\PelIfd $pelSubIfdGps, $latitudeDegreeDecimal, $longitudeDegreeDecimal): void {
